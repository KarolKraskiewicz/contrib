...
func TestEvictReplicatedByController(t *testing.T) {
	...
	eviction := NewPodsEvictionRestrictionFactory(fakeClient(&rc, nil, pods), 2, 0.5).NewPodsEvictionRestriction(pods)
...
func TestEvictReplicatedByReplicaSet(t *testing.T) {
	...
	eviction := NewPodsEvictionRestrictionFactory(fakeClient(nil, &rs, pods), 2, 0.5).NewPodsEvictionRestriction(pods)
...
func TestEvictTooFewReplicas(t *testing.T) {
	...
	eviction := NewPodsEvictionRestrictionFactory(fakeClient(&rc, nil, pods), 10, 0.5).NewPodsEvictionRestriction(pods)
