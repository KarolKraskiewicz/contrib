...
type UpdatePriorityCalculator struct {
	resourcesPolicy *api_mock.ResourcesPolicy
...
func NewUpdatePriorityCalculator(policy *api_mock.ResourcesPolicy, config *UpdateConfig) UpdatePriorityCalculator {
	if config == nil {
...
func (calc *UpdatePriorityCalculator) AddPod(pod *apiv1.Pod, recommendation *api_mock.Recommendation) {
...
func (calc *UpdatePriorityCalculator) getUpdatePriority(pod *apiv1.Pod, recommendation *api_mock.Recommendation) float64 {
	var priority float64 = 0.0
...
func getPercentageDiff(actual *resource.Quantity, policy *api_mock.Policy, recommendation *resource.Quantity) float64 {
...
func getContainerPolicy(containerName string, policy *api_mock.ResourcesPolicy) (memory, cpu *api_mock.Policy) {
	if policy != nil {
...
func getContainerRecommendation(containerName string, recommendation *api_mock.Recommendation) *api_mock.ContainerRecommendation {
